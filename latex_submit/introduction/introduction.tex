...
\begin{table}[h]
    ...
    \begin{tabular}{|c|c|}
        ...
        Dimensions(WxLxH) [$\si{mm,mm,mm}$] & $38,59 \times 38,59 \times 33,50$\\
...
The second objective is the utilisation of hardware tools, such as the Raspberry Pi Pico 2 W microcontroller\footnote[2]{\url{https://www.raspberrypi.com/products/raspberry-pi-pico-2/}} for data acquisition, and software tools, such as the Python library Open3D \cite{zhou_Open3DModernLibrary_2018} for the 3D scene reconstruction.