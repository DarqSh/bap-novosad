...
threshold = 0.3 # max distance between two misaligned points (in m)

reg = o3d.pipelines.registration.registration_icp( # https://www.open3d.org/docs/latest/python_api/open3d.t.pipelines.registration.icp.html
    pcd_one_stat,
    pcd_two_stat,
    threshold,
    np.eye(4),
...
print(reg.transformation)   # matrix of transformation, 4x4
                            # | R t |
                            # | 0 1 |
                            # R 3x3, t 3x1

pcd_one_stat.transform(reg.transformation)
o3d.visualization.draw_geometries([pcd_one_stat, pcd_two_stat])