...
However, even the cheapest commercial 3D \gls{lidar} sensor, which was found during the research for this project, costs 249~\euro\,\cite{_4DLidarL1_}.

This project addresses two main objectives. The first objective is the development of a cost-effective platform for a $360\,\degree$ STL-19P \gls{lidar} sensor that enables 3D spatial scanning using a 2D \gls{lidar} sensor.
\begin{figure}[h]
    \centering
